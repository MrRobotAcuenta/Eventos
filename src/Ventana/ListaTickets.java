...
public class ListaTickets extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListaTickets frame = new ListaTickets();
	...
	public ListaTickets() {
		...
		scrollPane.setBounds(12, 40, 612, 151);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Asiento", "Precio", "Id Ticket", "Evento", "Rut"
			}
		) {
		...
		btnModificar.setBounds(112, 248, 97, 25);
		...
		btnAtras.setBounds(364, 248, 97, 25);
